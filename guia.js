...
decir [¡Guau!] durante (2) segundos</pre>
        ...
        <ul class="guia-lista">
          ...
          <li>En el Paso 1, la tarjeta <strong>"🪜 Guía paso a paso"</strong> convierte las fichas en <strong>PASO 1, PASO 2…</strong> de un mismo proyecto: ideal para tutoriales de juegos completos. El Asistente IA tiene la opción <strong>"Guía paso a paso (tutorial de un juego completo)"</strong> que genera todos los pasos de una vez, con teoría y código por personaje.</li>
