...
export const PIEZAS = [
  ...
  { clave: 'viga angular 3x5', dat: '32526', nombre: 'Viga angular 3×5 (90°)', w: 5, d: 3, alto: 2.5, studs: 'ninguna', cat: 'Vigas NXT', nxt: 8, bbox: true },
  { clave: 'viga angular 2x4', dat: '32140', nombre: 'Viga angular 2×4 (90°)', w: 4, d: 2, alto: 2.5, studs: 'ninguna', cat: 'Vigas NXT', nxt: 4, bbox: true },
  { clave: 'viga angular 4x6', dat: '6629', nombre: 'Viga angular 4×6 (53°)', w: 6, d: 4, alto: 2.5, studs: 'ninguna', cat: 'Vigas NXT', nxt: 4, bbox: true },
  { clave: 'viga doble angular 3x7', dat: '32009', nombre: 'Viga doble angular 3×7 (45°)', w: 7, d: 3, alto: 2.5, studs: 'ninguna', cat: 'Vigas NXT', nxt: 4, bbox: true },
  { clave: 'viga curva 3x5', dat: '32250', nombre: 'Viga curva 3×5 (media, cuarto de elipse)', w: 5, d: 3, alto: 1.5, studs: 'ninguna', cat: 'Vigas NXT', nxt: 4, bbox: true },
  ...
  { clave: 'buje', dat: '6590', nombre: 'Buje para eje', w: 1, d: 1, alto: 1, studs: 'ninguna', cat: 'Técnicas', nxt: 10, suelta: true, redonda: true },
  { clave: 'medio buje', dat: '32123a', nombre: 'Medio buje', w: 1, d: 1, alto: 1, studs: 'ninguna', cat: 'Técnicas', nxt: 10, suelta: true, redonda: true },
  ...
  // --- Engranajes ---
  { clave: 'engranaje 8', dat: '3647', nombre: 'Engranaje 8 dientes', w: 1, d: 1, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 8, suelta: true, redonda: true },
  { clave: 'engranaje 16', dat: '94925', nombre: 'Engranaje 16 dientes', w: 2, d: 2, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 4, suelta: true, redonda: true },
  { clave: 'engranaje 24', dat: '3648', nombre: 'Engranaje 24 dientes', w: 3, d: 3, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 8, suelta: true, redonda: true },
  { clave: 'engranaje 40', dat: '3649', nombre: 'Engranaje 40 dientes', w: 5, d: 5, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 2, suelta: true, redonda: true },
  { clave: 'corona 24', dat: '3650c', nombre: 'Corona 24 dientes', w: 3, d: 3, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 2, suelta: true, redonda: true },
  { clave: 'tornillo sin fin', dat: '4716', nombre: 'Tornillo sin fin', w: 1, d: 1, alto: 2, studs: 'ninguna', cat: 'Engranajes', nxt: 4, suelta: true },
  { clave: 'engranaje conico 12', dat: '32270', nombre: 'Engranaje doble cónico 12 dientes', w: 2, d: 2, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 4, suelta: true, redonda: true },
  { clave: 'engranaje conico 20', dat: '32269', nombre: 'Engranaje doble cónico 20 dientes', w: 3, d: 3, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 4, suelta: true, redonda: true },
  { clave: 'engranaje conico 36', dat: '32498', nombre: 'Engranaje doble cónico 36 dientes', w: 5, d: 5, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 2, suelta: true, redonda: true },
  { clave: 'rueda de mando', dat: '32072', nombre: 'Rueda de mando (knob)', w: 1, d: 1, alto: 1, studs: 'ninguna', cat: 'Engranajes', nxt: 4, suelta: true },
  // --- Ruedas y poleas del kit ---
  { clave: 'llanta nxt', dat: '56145', nombre: 'Llanta NXT 30×20 (6 rayos)', w: 4, d: 4, alto: 4, studs: 'ninguna', cat: 'Ruedas', nxt: 4, suelta: true, redonda: true, bbox: true },
  { clave: 'neumatico nxt', dat: '55976', nombre: 'Neumático todoterreno 56×26', w: 7, d: 7, alto: 4, studs: 'ninguna', cat: 'Ruedas', nxt: 4, suelta: true, redonda: true, bbox: true },
  { clave: 'llanta chica nxt', dat: '55981', nombre: 'Llanta 18×14 con agujeros', w: 3, d: 3, alto: 2, studs: 'ninguna', cat: 'Ruedas', nxt: 2, suelta: true, redonda: true, bbox: true },
  { clave: 'neumatico chico nxt', dat: '89201', nombre: 'Neumático bajo 24×14', w: 4, d: 4, alto: 2, studs: 'ninguna', cat: 'Ruedas', nxt: 2, suelta: true, redonda: true, bbox: true },
  { clave: 'polea', dat: '4185a', nombre: 'Polea (rueda de correa) 24', w: 3, d: 3, alto: 1, studs: 'ninguna', cat: 'Ruedas', nxt: 4, suelta: true, redonda: true },
  { clave: 'neumatico de polea', dat: '2815', nombre: 'Neumático de polea', w: 3, d: 3, alto: 1, studs: 'ninguna', cat: 'Ruedas', nxt: 4, suelta: true, redonda: true },
  // --- Electrónica NXT ---
  { clave: 'bloque nxt', dat: '53788', nombre: 'Bloque inteligente NXT', w: 9, d: 14, alto: 12, studs: 'ninguna', cat: 'Electrónica NXT', nxt: 1, bbox: true },
  { clave: 'motor nxt', dat: '53787', nombre: 'Servomotor NXT', w: 9, d: 6, alto: 8, studs: 'ninguna', cat: 'Electrónica NXT', nxt: 3, bbox: true },
  { clave: 'sensor ultrasonico', dat: '53792', nombre: 'Sensor ultrasónico NXT', w: 5, d: 4, alto: 8, studs: 'ninguna', cat: 'Electrónica NXT', nxt: 1, bbox: true },
  { clave: 'sensor de contacto', dat: '53793', nombre: 'Sensor de contacto NXT', w: 4, d: 3, alto: 8, studs: 'ninguna', cat: 'Electrónica NXT', nxt: 2, bbox: true },
  { clave: 'sensor de sonido', dat: '55963', nombre: 'Sensor de sonido NXT', w: 4, d: 3, alto: 8, studs: 'ninguna', cat: 'Electrónica NXT', nxt: 1, bbox: true },
  { clave: 'sensor de luz', dat: '55969', nombre: 'Sensor de luz NXT', w: 4, d: 3, alto: 8, studs: 'ninguna', cat: 'Electrónica NXT', nxt: 1, bbox: true },
];
